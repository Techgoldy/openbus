...
@SiddhiExtension(namespace = "agregacion", function = "mediaCondAnteriorIntPorcentaje")
public class MediaCondicionadaAnteriorAggregatorFactory implements OutputAttributeAggregatorFactory {

	@Override
	public OutputAttributeAggregator createAttributeAggregator(Type[] types) {
		// TODO Auto-generated method stub
		return new MediaCondicionadaAnteriorAggregatorInteger();
	}
}
